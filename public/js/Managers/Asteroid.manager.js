class AsteroidManager {
  ...
  static preloadAsteroides(scene) {
    scene.load.image("asteroid_ron", "./js/stages/StarshipTraveling/ressources/images/prop_asteroide_ron.png");
    scene.load.image("asteroid_flat", "./js/stages/StarshipTraveling/ressources/images/prop_asteroide_flat.png");
    scene.load.image("asteroid_broken", "./js/stages/StarshipTraveling/ressources/images/prop_asteroide_broken.png");
  }
